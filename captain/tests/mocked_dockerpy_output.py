...
__inspect_container_cmd_return = {
    ...
    "1ca0e49fcd60fa": {
        ...
        u'Config': {u'AttachStderr': False,
                    ...
                    u'Env': [u'HMRC_CONFIG=-Dapplication.log=INFO -Drun.mode=Prod -Dlogger.resource=/application-json-logger.xml -Dhttp.port=8080',
                             u'JAVA_OPTS=-Xmx256m -Xms256m',
                             u'SLUG_URL=https://webstore.tax.service.gov.uk/attorney/attorney_46.tgz',
                             u'PORT=8080',
                             u'HOME=/',
                             u'PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin'],
                    u'ExposedPorts': {u'8080/tcp': {}},
...
containers = [
    {"id": "656ca7c307d178", "app": "ers-checking-frontend-27", "version": None, "port": 9225},
    {"id": "eba8bea2600029", "app": "paye", "version": "216", "port": 9317},
    {"id": "1ca0e49fcd60fa", "app": "attorney", "version": "46", "port": 9344},
]
